...
1. Se extrae la información de los talleres en formato '.csv' de la BD.
...
Me permite automatizar el filtrado de un listado para la extracción de datos de Asesores de Servicio (ASP). Con estos listados puedo plasmar información a través del número de un Asesor de servicio (ASP), por ejemplo la contabilización de pasos por día, elementos de desgaste, como neumáticos vendidos....
